...
MandelbrotExtended::MandelbrotExtended(const MandelbrotExtended& mandelbrotExtended) :
	Fractal(FractalsType::MANDELBROT, nullptr),
	m_center(mandelbrotExtended.m_center),
	m_offset(std::clamp(mandelbrotExtended.m_offset, 1e-13, 2.)),
	m_mousePosition(nullptr)
{
	init();
}

MandelbrotExtended::MandelbrotExtended(const hgui::dvec2& center) :
	Fractal(FractalsType::MANDELBROT, nullptr),
...
const hgui::dvec2& MandelbrotExtended::get_center() const
{
	return m_center;
}

double MandelbrotExtended::get_offset() const
{
	return m_offset;
}
